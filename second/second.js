...
document.addEventListener("DOMContentLoaded", () => {
    ...
    let condition = e.target.dataset.condition
    isRunning = !isRunning
    if (isRunning) {
      condition = 'pause'
      e.target.textContent = 'PAUSE'
      timerInterval = setInterval(() => {
        if (!isRunning || changingTime === 0) {
          clearInterval(timerInterval)
          condition = !changingTime? "restart" : "start"
...
//   let changingTime = timeForPomodoro
//   let isRunning = false
...
//   toggler.addEventListener('click', toggleTimer)
...
//     if (
//       toggler.textContent === 'START' ||
//       toggler.textContent === 'RESTART' ||
//       toggler.textContent === 'RESUME'
//     ) {
//       toggler.textContent = 'PAUSE'
//       timerInterval = setInterval(() => {
//         if (!isRunning) {
//           clearInterval(timerInterval)
//           toggler.textContent = 'START'
//         } else if (changingTime <= 1000) {
//           clearInterval(timerInterval)
//           toggler.textContent = 'RESTART'
//           changingTime = changingTime + 1000
//         }
//         isRunning && (changingTime -= 1000)
//         assignTime(changingTime)
//       }, 1000)
